...
<body>
					...
					<table cellpadding="0" cellspacing="0" class="mainForm">
					  <div class="providerView">
                       ...
                       <select name="dutyname" style="width:80px">
                            <c:forEach items="${plandutyList1}"  var="plandutyList1" varStatus="status">
			   						<option value="${plandutyList1.dutyname}" 
			   							selected="selected"
			   						>${plandutyList1.dutyname}</option>
			   				</c:forEach>
    ...
    <table class="MainArea_Content" cellspacing="0" cellpadding="0">
		...
		<!--显示数据列表 -->
		<tbody id="TableData">
		  <c:forEach items="${seekplanList }"  var="seekplanList" >
			<tr class="TableDetail1">
				<td align="center">${seekplanList.planname }</td>
				<td align="center">${seekplanList.dutyname }</td>
				<td align="center">${seekplanList.planstarttime }</td>
				<td align="center">${seekplanList.planendtime }</td>
				<td align="center">${seekplanList.planstatus }</td>
				<td align="center">${seekplanList.planfeedback }</td>
			</tr>
		  </c:forEach>
        </tbody>
    </table>
