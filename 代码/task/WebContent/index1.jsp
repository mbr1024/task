...
<title>任务管理系统</title>
	...
	<frameset rows="100px,*,19px" framespacing="0" border="0" frameborder="0">
		<frame src="top1.jsp" scrolling="no" noresize /> 
		<frameset cols="178px,*">
			<frame noresize src="left1.jsp" scrolling="yes" /> 
	...
	<noframes>
		<body>
			你的浏览器不支持框架布局，推荐你使用<a href="http://www.firefox.com.cn/download/" style="text-decoration: none;">chrome浏览器</a>,
